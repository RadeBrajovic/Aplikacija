...
export class AdministratorController {
    ...
    // POST  http://localhost:3000/api/administrator/  // Dodajemo novog administratora
    @Post()
    @UseGuards(RoleCheckedGuard)
    @AllowToRoles('administrator')
    ...
    // PATCH http://localhost:3000/api/administrator/4/ // Editujemo postojeci sadrzaj nekog administratora
    @Patch(':id')
    @UseGuards(RoleCheckedGuard)
    @AllowToRoles('administrator')
